...
extensions = {
    ...
    'rv64i': ['add', 'addi', 'addiw', 'addw', 'and', 'andi', 'auipc', 'beq', 'bge', 'bgeu', 'blt', 'bltu', 'bne', 'jal', 'jalr', 'lb', 'lbu', 'ld', 'lh', 'lhu', 'lui', 'lw','lwu', 'or', 'ori', 'sb', 'sd', 'sh', 'sll', 'slli', 'slliw', 'sllw', 'slt', 'slti', 'sltiu', 'sltu', 'sra', 'srai', 'sraiw', 'sraw', 'srl', 'srli', 'srliw', 'srlw', 'sub', 'subw', 'sw', 'xor', 'xori'],
    'rv32mi': ['div', 'divu', 'mul', 'mulh', 'mulhsu', 'mulhu', 'rem','remu'],
    'rv64mi': ['div', 'divu', 'mul', 'mulh', 'mulhsu', 'mulhu', 'rem', 'remu', 'divuw', 'divw', 'mulw', 'mulh', 'mulhu', 'mulhsu', 'remuw', 'remw'],
