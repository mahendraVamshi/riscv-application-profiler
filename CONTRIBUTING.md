...
Report bugs using Github's `issues <https://github.com/mahendraVamshi/riscv-application-profiler/issues>`_
------------------------------------------------------------------------------------

We use GitHub issues to track public bugs. Report a bug by `opening a new issue <https://github.com/mahendraVamshi/riscv-application-profiler/issues/new>`_  it's that easy!
